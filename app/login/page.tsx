...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a1829] flex flex-col justify-between p-4 sm:p-6 text-white font-sans relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center relative z-10 py-8">
        <div className="bg-white rounded-3xl p-6 sm:p-10 text-slate-900 shadow-2xl w-full max-w-md space-y-6 border border-slate-100">
          ...
          <div className="text-center space-y-2">
            <div className="w-14 h-14 bg-amber-50 border-2 border-amber-200/80 rounded-2xl flex items-center justify-center mx-auto text-[#ffb800] shadow-sm">
                ...
                return (
                  <button
                    ...
                    className={`p-3 rounded-2xl border transition-all duration-200 flex flex-col items-center justify-center gap-1 ${isSelected
                      ? "border-[#ffb800] bg-amber-50 text-[#ffb800] ring-2 ring-[#ffb800]/20 font-black shadow-sm"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl focus:border-[#ffb800] outline-none text-xs font-bold text-slate-900 placeholder:text-slate-400 bg-slate-50/50"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 border border-slate-200 rounded-xl focus:border-[#ffb800] outline-none text-xs font-bold text-slate-900 placeholder:text-slate-400 bg-slate-50/50"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#ffb800] hover:bg-[#ffa000] text-white font-black py-3.5 rounded-xl transition-all shadow-lg text-xs uppercase tracking-wider flex items-center justify-center gap-2"
            >
              {loading ? (
                "Signing In..."
              ) : (
          ...
          <div className="text-center border-t border-slate-100 pt-4">
            <p className="text-slate-500 text-xs font-medium">
              ...
              <Link href="/signup" className="text-[#ffb800] font-black hover:underline">
                Create an Account
              </Link>
            </p>
          </div>
